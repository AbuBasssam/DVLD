...
namespace DVLD.Tests
{
    public partial class ctrlScheduleTest : UserControl
    {
                    ...
                    case clsTestTypes.enTestType.StreetTest:
                        {
                            ...
                            pbTestTypeImage.Image = Resources.car_Test;
                            break;
        ...
        public void LoadInfo(int LocalDrivingLicenseApplicationID, int AppointmentID = -1)
        {
            ...
            lblDrivingClass.Text = _LocalDrivingLicenseApplication.License.ClassName;
            lblFullName.Text = _LocalDrivingLicenseApplication.ApplicationInfo.Person.FullName();
        ...
        private bool _HandleRetakeApplication()
        {
            ...
            if (_Mode == enMode.AddNew && _CreationMode == enCreationMode.RetakeTestSchedule)
            {
                ...
                Application.ApplicationPersonID = (int)_LocalDrivingLicenseApplication.ApplicationInfo.Person.PersonID;
                ...
                _TestAppointment.RetakeTestApplicationID = (int)Application.ApplicationID;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            _TestAppointment.LocalDrivingApplicationID = _LocalDrivingLicenseApplication.LocalDrivingLicenseApplicationID;
            _TestAppointment.AppointmentDate = dtpTestDate.Value;
            _TestAppointment.PaidFees = Convert.ToSingle(lblFees.Text);
            _TestAppointment.CreatedBy = (int)clsGlobal.CurrentUser.UserID;
